module Legato
  class Query
    ...
    attr_accessor :sort, :limit, :offset, :segment, :custom_filter # individual, overwritten
    ...
    def apply_basic_options(options)
      [:sort, :limit, :offset, :start_date, :end_date, :segment, :custom_filter].each do |key| #:segment
